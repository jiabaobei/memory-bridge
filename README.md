...
| 全自动同步 | 云盘自动选定（多盘按优先级）、口令由系统生成并托管（用户无感，v0.22 起托管覆盖 Windows / Linux / macOS 全平台）、按重要程度自动上云（计划任务每 15 分钟），零点击 | ✅ v0.5/v0.6/v0.22 |
